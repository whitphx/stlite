...
streamlit_wheel := packages/kernel/py/streamlit/lib/dist/streamlit-1.19.0-py2.py3-none-any.whl
...
$(streamlit_wheel): $(VENV) $(streamlit_proto) streamlit/lib/streamlit/**/*.py streamlit/lib/Pipfile streamlit/lib/setup.py streamlit/lib/bin/* streamlit/lib/MANIFEST.in
	...
	cp streamlit/lib/dist/streamlit-1.19.0-py2.py3-none-any.whl $(streamlit_wheel)
