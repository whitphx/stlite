...
function N(o, e) {
  for (var t = "", s = 0, n = -1, r = 0, a, i = 0; i <= o.length; ++i) {
    if (i < o.length)
      a = o.charCodeAt(i);
    else {
      if (a === 47)
      ...
      if (!(n === i - 1 || r === 1)) if (n !== i - 1 && r === 2) {
        if (t.length < 2 || s !== 2 || t.charCodeAt(t.length - 1) !== 46 || t.charCodeAt(t.length - 2) !== 46) {
          if (t.length > 2) {
            var l = t.lastIndexOf("/");
            if (l !== t.length - 1) {
              l === -1 ? (t = "", s = 0) : (t = t.slice(0, l), s = t.length - 1 - t.lastIndexOf("/")), n = i, r = 0;
              continue;
            }
        ...
        t.length > 0 ? t += "/" + o.slice(n + 1, i) : t = o.slice(n + 1, i), s = i - n - 1;
      n = i, r = 0;
    } else a === 46 && r !== -1 ? ++r : r = -1;
  }
  return t;
...
function ee(o, e) {
  ...
  return t ? t === e.root ? t + s : t + o + s : s;
}
var L = {
  // path.resolve([from ...], to)
  resolve: function() {
    for (var e = "", t = !1, s, n = arguments.length - 1; n >= -1 && !t; n--) {
      var r;
      n >= 0 ? r = arguments[n] : (s === void 0 && (s = process.cwd()), r = s), w(r), r.length !== 0 && (e = r + "/" + e, t = r.charCodeAt(0) === 47);
    }
  ...
  normalize: function(e) {
    ...
    return e = N(e, !t), e.length === 0 && !t && (e = "."), e.length > 0 && s && (e += "/"), t ? "/" + e : e;
  },
  ...
  join: function() {
    ...
    for (var e, t = 0; t < arguments.length; ++t) {
      var s = arguments[t];
      w(s), s.length > 0 && (e === void 0 ? e = s : e += "/" + s);
    }
  ...
  relative: function(e, t) {
    ...
    for (var s = 1; s < e.length && e.charCodeAt(s) === 47; ++s)
      ;
    for (var n = e.length, r = n - s, a = 1; a < t.length && t.charCodeAt(a) === 47; ++a)
      ;
    for (var i = t.length, l = i - a, _ = r < l ? r : l, f = -1, c = 0; c <= _; ++c) {
      if (c === _) {
        if (l > _) {
          ...
          if (c === 0)
            return t.slice(a + c);
        } else r > _ && (e.charCodeAt(s + c) === 47 ? f = c : c === 0 && (f = 0));
        break;
      }
      var m = e.charCodeAt(s + c), R = t.charCodeAt(a + c);
      if (m !== R)
        break;
      m === 47 && (f = c);
    }
  ...
  dirname: function(e) {
    if (w(e), e.length === 0) return ".";
    for (var t = e.charCodeAt(0), s = t === 47, n = -1, r = !0, a = e.length - 1; a >= 1; --a)
      if (t = e.charCodeAt(a), t === 47) {
        ...
        r = !1;
    return n === -1 ? s ? "/" : "." : s && n === 1 ? "//" : e.slice(0, n);
  },
  basename: function(e, t) {
    ...
    if (t !== void 0 && t.length > 0 && t.length <= e.length) {
      ...
      return s === n ? n = l : n === -1 && (n = e.length), e.slice(s, n);
    } else {
      for (a = e.length - 1; a >= 0; --a)
  ...
  extname: function(e) {
    w(e);
    for (var t = -1, s = 0, n = -1, r = !0, a = 0, i = e.length - 1; i >= 0; --i) {
  ...
  parse: function(e) {
    ...
    var s = e.charCodeAt(0), n = s === 47, r;
    n ? (t.root = "/", r = 1) : r = 0;
    for (var a = -1, i = 0, l = -1, _ = !0, f = e.length - 1, c = 0; f >= r; --f) {
      if (s = e.charCodeAt(f), s === 47) {
        if (!_) {
          i = f + 1;
          break;
        }
      ...
      l === -1 && (_ = !1, l = f + 1), s === 46 ? a === -1 ? a = f : c !== 1 && (c = 1) : a !== -1 && (c = -1);
    }
...
const H = "/home/pyodide", B = (o) => `${H}/${o}`, F = (o, e) => o == null ? M.resolve(H, e) : M.resolve(B(o), e);
function z(o, e) {
...
function U(o, e, t, s) {
  z(o, e), o.FS.writeFile(e, t, s);
}
function re(o, e, t) {
  z(o, t), o.FS.rename(e, t);
}
const oe = "[", se = "(<=>!~", ne = ";", ae = "@", ie = new RegExp(
  `[${oe + se + ne + ae}]`
);
function le(o) {
  return o.split(ie)[0].trim();
}
function W(o) {
  return o.forEach((t) => {
    let s;
    ...
    if (s.protocol === "emfs:" || s.protocol === "file:")
      throw new Error(
        `"emfs:" and "file:" protocols are not allowed for the requirement (${t})`
      );
  }), o.filter((t) => le(t) === "streamlit" ? (console.warn(
...
async function ce(o) {
  ...
  const s = o.slice(0, o.lastIndexOf(t) + 1);
  if (o.endsWith(".mjs")) {
    if (e) {
      ...
      !o.includes("://") && n.isAbsolute(o) && (o = r.pathToFileURL(o).href);
    }
    return {
      scriptURL: o,
      pyodideIndexURL: s,
...
async function de(o, e) {
  const { scriptURL: t, pyodideIndexURL: s, isESModule: n } = await ce(o);
  let r;
  return n ? r = (await import(
    /* webpackIgnore: true */
    /* @vite-ignore */
    t
  )).loadPyodide : (importScripts(t), r = self.loadPyodide), r({ ...e, indexURL: s });
}
function ge(o) {
  o.runPython(`
import micropip
...
async function fe(o, e, t) {
  const s = o.pyimport("pyodide"), n = (f) => s.code.find_imports(f).toJs(), r = t.map((f) => n(f)), l = Array.from(new Set(r.flat())).filter((f) => !o.runPython(`__import__('importlib').util.find_spec('${f}')`)).map((f) => o._api._import_name_to_package_name.get(f)).filter((f) => f);
  if (l.length === 0)
    return;
...
function $(o, e, t) {
  const s = fe(o, e, t);
  self.__moduleAutoLoadPromise__ = s, o.runPythonAsync(`
...
function j(o, e, t, s) {
  ...
  async function l() {
    ...
    const { entrypoint: R, files: v, archives: b, requirements: d, prebuiltPackageNames: u, wheels: h, pyodideUrl: y = o, streamlitConfig: S, idbfsMountpoints: P, nodefsMountpoints: C, moduleAutoLoad: J } = m, E = W(d);
...
`), console.debug("Set up the IndexedDB filesystem synchronizer");
    ...
    const O = F(s, R);
    return n("Booting up the Streamlit server."), console.debug("Setting up the Streamlit configuration"), self.__sharedWorkerMode__ = s != null, self.__streamlitFlagOptions__ = {
...
`), console.debug("Set up the Streamlit configuration"), console.debug("Booting up the Streamlit server"), a = r.pyimport("stlite_lib.server.Server")(O, s ? B(s) : null), await a.start(), console.debug("Booted up the Streamlit server"), e({
      type: "event:loaded"
    }), m;
  }
  const _ = l().catch((c) => {
    ...
    try {
      switch (m.type) {
        ...
        case "file:write": {
          const { path: d, data: u, opts: h } = m.data, y = F(s, d);
        ...
        case "file:rename": {
          const { oldPath: d, newPath: u } = m.data, h = F(s, d), y = F(s, u);
...
function me(o) {
  let e = "";
  for (let t = 0; t < o; t++) {
    const s = Math.floor(Math.random() * ue);
    e += x[s];
  }
  return e;
}
const q = "https://cdn.jsdelivr.net/pyodide/v0.26.2/full/pyodide.mjs";
if ("postMessage" in self)
  self.onmessage = j(q, (o, e) => e ? self.postMessage(o, [e]) : self.postMessage(o));
else {
  const o = [];
  self.onconnect = (e) => {
    let t;
    ...
    const s = e.ports[0];
    s.onmessage = j(q, (n, r) => r ? s.postMessage(n, [r]) : s.postMessage(n), void 0, t), s.start();
  };
}
//# sourceMappingURL=worker-DaUJrTPv.js.map
