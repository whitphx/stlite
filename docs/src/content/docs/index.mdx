...
import stliteLogoLight from '../../assets/stlite.svg';
import stliteLogoDark from '../../assets/stlite-dark.svg';
import { Image } from 'astro:assets';

<div class="hero-custom-layout">
  <div class="hero-content">
    <div class="hero-logo-container">
       <Image src={stliteLogoDark} alt="Stlite Logo" class="hero-logo hero-logo-dark" />
       <Image src={stliteLogoLight} alt="Stlite Logo" class="hero-logo hero-logo-light" />
    </div>
