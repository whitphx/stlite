...
//
// This re-export only satisfies App.tsx's import binding: its runtime branch
// takes the server-backed arm when no kernel is in context (always, in this
// build), so this class is imported but never constructed here.
...
export function useDownloadFileFromStlite(): (url: string) => void {
  return (url: string) => {
