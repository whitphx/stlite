...
<div class="hero-custom-layout">
  <div class="hero-left">
    <div class="hero-logo-container">
       <Image src={stliteLogoDark} alt="Stlite Logo" class="hero-logo light:sl-hidden" />
       <Image src={stliteLogoLight} alt="Stlite Logo" class="hero-logo dark:sl-hidden" />
    </div>
    <div class="hero-tagline">
      <h1>Serverless Streamlit Running Entirely in Your Browser</h1>
    </div>
    <div class="hero-actions">
      <LinkButton href="/browser" icon="right-arrow" variant="primary">Get Started</LinkButton>
      <LinkButton href="https://github.com/whitphx/stlite" icon="external" variant="secondary">View on GitHub</LinkButton>
    </div>
  </div>
  <div class="hero-right">
    <div class="playground-placeholder">
      <p>Live Playground Demo (Coming Soon)</p>
    </div>
  </div>
</div>
