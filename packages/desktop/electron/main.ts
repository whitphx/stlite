...
const createWindow = () => {
  ...
  ipcMain.handle("readRequirements", async (ev): Promise<string[]> => {
    ...
    return requirementsTxtData.split("\n"); // Assuming that the input `requirements.txt` file is generated by `dump-artifacts.js` and can be parsed with this simple logic.
  });
  ipcMain.handle(
