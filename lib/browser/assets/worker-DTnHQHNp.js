...
function z(o, e, t, n) {
  ...
  async function c() {
    ...
    const { entrypoint: L, files: v, archives: b, requirements: l, prebuiltPackageNames: g, wheels: h, pyodideUrl: y = o, streamlitConfig: k, idbfsMountpoints: P, nodefsMountpoints: R, moduleAutoLoad: G, env: M, languageServer: V } = f, I = W(l);
    ...
    try {
      switch (f.type) {
        ...
        case "file:write": {
          ...
          L && typeof g == "string" && y.endsWith(".py") && (console.debug(`Auto install the requirements in ${y}`), $(r, e, [g])), console.debug(`Write a file "${y}"`), U(r, y, g, h), b({
            type: "reply"
          });
          break;
        }
        ...
        case "install": {
          const { requirements: l } = f.data, g = r.pyimport("micropip"), h = W(l);
...
if ("postMessage" in self)
  self.onmessage = z(q, (o, e) => e ? self.postMessage(o, [e]) : self.postMessage(o));
else {
  const o = [];
  self.onconnect = (e) => {
    let t;
    ...
    const n = e.ports[0];
    n.onmessage = z(q, (s, r) => r ? n.postMessage(s, [r]) : n.postMessage(s), void 0, t), n.start();
  };
}
//# sourceMappingURL=worker-DTnHQHNp.js.map
