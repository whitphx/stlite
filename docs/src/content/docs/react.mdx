...
import sharedWorkerApp from '../../../../packages/react/demos/multi-app-shared-worker/App.tsx?raw';
import idbfsApp from '../../../../packages/react/demos/idbfs/App.tsx?raw';
...
:::tip
When embedding apps in a non-fullscreen manner, set `disableDocumentStyles` to prevent setting global styles.
:::
...
- SharedWorker is not supported in all browsers (e.g., Chrome on Android)
...
<Code code={idbfsApp} lang="tsx" title="IdbfsApp.tsx" />
