...
import stliteLogo from '../../assets/icon.svg';
  ...
  <div class="hero-content">
    <div class="hero-copy">
      <div class="hero-tagline">
        <h1>Stlite: In&#8209;browser Streamlit</h1>
        <p class="hero-subtitle">Serverless Streamlit Running Entirely in Your Browser</p>
      </div>
      <div class="hero-actions">
        <LinkButton href="https://edit.share.stlite.net/" variant="primary" icon="rocket" target="_blank">Try it Online</LinkButton>
        <LinkButton href="/browser" variant="secondary">Get Started</LinkButton>
        <LinkButton href="https://github.com/whitphx/stlite" variant="minimal" icon="external" target="_blank">View on GitHub</LinkButton>
      </div>
    </div>
...
<div class="sponsors-layout">
  ...
  <div class="sponsor-tier tier-2">
    <a href="https://www.testmu.ai?utm_source=stlite&utm_medium=sponsor" target="_blank">
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="https://assets.testmu.ai/resources/images/logos/white-logo.png" />
        <source media="(prefers-color-scheme: light)" srcset="https://assets.testmu.ai/resources/images/logos/black-logo.png" />
        <img src="https://assets.testmu.ai/resources/images/logos/white-logo.png" alt="TestMu AI" class="sponsor-logo h-72" />
      </picture>
    </a>
  </div>
