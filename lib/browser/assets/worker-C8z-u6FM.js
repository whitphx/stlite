  ...
  var u = {
    ...
    relative: function(e, t) {
      ...
      for (var a = e.length, d = a - s, r = 1; r < t.length && t.charCodeAt(r) === 47; ++r)
        ;
      for (var l = t.length, g = l - r, S = d < g ? d : g, v = -1, h = 0; h <= S; ++h) {
        if (h === S) {
          if (g > S) {
            ...
            if (h === 0)
              return t.slice(r + h);
          } else d > S && (e.charCodeAt(s + h) === 47 ? v = h : h === 0 && (v = 0));
          break;
        }
      ...
      var b = "";
      for (h = s + v + 1; h <= a; ++h)
        (h === a || e.charCodeAt(h) === 47) && (b.length === 0 ? b += ".." : b += "/..");
    ...
    parse: function(e) {
      ...
      a ? (t.root = "/", d = 1) : d = 0;
      for (var r = -1, l = 0, g = -1, S = !0, v = e.length - 1, h = 0; v >= d; --v) {
        ...
        g === -1 && (S = !1, g = v + 1), s === 46 ? r === -1 ? r = v : h !== 1 && (h = 1) : r !== -1 && (h = -1);
      }
...
function W(o, c, f, u) {
  N(o, c), o.FS.writeFile(c, f, u);
}
function te(o, c, f) {
  N(o, f), o.FS.rename(c, f);
}
...
async function fe(o, c, f, u, i) {
  const { files: e, archives: t, requirements: s, prebuiltPackageNames: a, wheels: d, installs: r, pyodideUrl: l = o, streamlitConfig: g, idbfsMountpoints: S, nodefsMountpoints: v, moduleAutoLoad: h, env: P, languageServer: R } = f, b = q(s);
  if (O)
...
function B(o, c, f, u) {
  ...
  const a = async (d) => {
    ...
    const l = await t, g = l.pyodide, S = l.micropip, v = l.jedi, { moduleAutoLoad: h } = l.initData, P = await s, R = d.ports[0];
    function b(n) {
      R.postMessage(n);
    }
    try {
      switch (r.type) {
        ...
        case "http:request": {
          ...
          const { request: n } = r.data, p = (_, w, F) => {
            ...
            console.debug({ statusCode: _, headers: L, body: E }), b({
              type: "http:response",
              data: {
                response: {
                  statusCode: _,
        ...
        case "file:write": {
          ...
          h && typeof p == "string" && w.endsWith(".py") && (console.debug(`Auto install the requirements in ${w}`), J(g, e, [p])), console.debug(`Write a file "${w}"`), W(g, w, p, _), b({
            type: "reply"
          });
          break;
        }
        case "file:rename": {
          ...
          console.debug(`Rename "${_}" to ${w}`), te(g, _, w), b({
            type: "reply"
          });
          break;
        }
        ...
        case "code_completion": {
          ...
          const { code: n, line: p, column: _ } = r.data, w = await ge(v, n, {
            line: p,
            column: _
          });
          b({
...
//# sourceMappingURL=worker-C8z-u6FM.js.map
