...
import srcAttributeHtml from '../../../../packages/browser/demos/src-attribute/index.html?raw';
...
import multiAppHtml from '../../../../packages/browser/demos/multi-app/index.html?raw';
import multiAppSharedWorkerHtml from '../../../../packages/browser/demos/multi-app-shared-worker/index.html?raw';
import idbfsHtml from '../../../../packages/browser/demos/idbfs/index.html?raw';
...
<Code code={toCdn(customElementHtml)} lang="html" title="custom-element.html" />

#### Loading from an external file

You can load the app from an external Python file using the `src` attribute:

<Code code={toCdn(srcAttributeHtml)} lang="html" title="src-attribute.html" />
...
<streamlit-app src="./main.py">
  ...
  <app-requirements> numpy pandas </app-requirements>
</streamlit-app>
```
...
### Multiple Apps on a Single Page
...
<Code code={toCdn(multiAppHtml)} lang="html" title="multi-app.html" />
...
<Code
  code={toCdn(multiAppSharedWorkerHtml)}
  lang="html"
  title="multi-app-shared-worker.html"
/>
...
<Code code={toCdn(idbfsHtml)} lang="html" title="idbfs.html" />
...
1. **Inline code**: Place Python code directly inside `<streamlit-app>`:
   ...
   ```html
   <streamlit-app> import streamlit as st st.write("Hello") </streamlit-app>
   ```
