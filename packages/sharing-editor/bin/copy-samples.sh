...
patch $SAMPLES_DIR/011_component_gallery/pages/data.audio_column.py $DIFF_DIR/011_component_gallery/pages/data.audio_column.py
cp $SOURCE_REPO_DIR/python/api-examples-source/tailwind_example.js $SAMPLES_DIR/011_component_gallery/pages/.
patch $SAMPLES_DIR/011_component_gallery/pages/components.tailwind.py $DIFF_DIR/011_component_gallery/pages/components.tailwind.py
