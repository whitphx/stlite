...
streamlit_wheel := packages/kernel/py/streamlit/lib/dist/streamlit-1.32.0-cp311-none-any.whl
...
$(streamlit_wheel): venv $(streamlit_proto) streamlit/lib/streamlit/**/*.py streamlit/lib/Pipfile streamlit/lib/setup.py streamlit/lib/bin/* streamlit/lib/MANIFEST.in
	...
	pyodide py-compile --keep streamlit/lib/dist/streamlit-1.32.0-py2.py3-none-any.whl && \
